...
import com.xxf.view.numberanimtext.NextProgress
import com.xxf.view.numberanimtext.PreviousProgress
import com.xxf.view.numberanimtext.TextManager
import com.xxf.view.numberanimtext.util.CircularList
import com.xxf.view.numberanimtext.util.ExtraList
...
open class CarryBitStrategy(val direction: Direction) : SimpleCharOrderStrategy() {
    ...
    override fun beforeCompute(sourceText: CharSequence, targetText: CharSequence, charPool: CharPool) {
        ...
        if (sourceText.length >= 30 || targetText.length >= 30) {
