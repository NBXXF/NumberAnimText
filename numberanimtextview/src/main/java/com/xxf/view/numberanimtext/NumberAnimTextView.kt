...
open class NumberAnimTextView : View {
    ...
    private fun init(context: Context, attrs: AttributeSet?, defStyleAttr: Int, defStyleRes: Int) {
        ...
        fun applyTypedArray(arr: TypedArray) {
            ...
            shadowColor = arr.getColor(R.styleable.NumberAnimTextView_android_shadowColor, shadowColor)
            shadowDx = arr.getFloat(R.styleable.NumberAnimTextView_android_shadowDx, shadowDx)
            shadowDy = arr.getFloat(R.styleable.NumberAnimTextView_android_shadowDy, shadowDy)
            shadowRadius = arr.getFloat(R.styleable.NumberAnimTextView_android_shadowRadius, shadowRadius)
            text = arr.getString(R.styleable.NumberAnimTextView_android_text) ?: ""
            textColor = arr.getColor(R.styleable.NumberAnimTextView_android_textColor, textColor)
            textSize = arr.getDimension(R.styleable.NumberAnimTextView_android_textSize, textSize)
            textStyle = arr.getInt(R.styleable.NumberAnimTextView_android_textStyle, textStyle)
        }
        ...
        animationDuration = arr.getInt(R.styleable.NumberAnimTextView_duration, animationDuration.toInt()).toLong()
